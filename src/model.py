...
#     model.add(Dense(activation='selu', units=32, kernel_initializer=initializer, kernel_regularizer='l2'))
    
#     model.add(Dense(activation='selu', units=16, kernel_initializer=initializer))
#     model.add(Dense(activation='selu', units=8, kernel_initializer=initializer))
